...
function EmploymentTable({ employmentData }) {
    const [filteredData, setFilteredData] = useState(employmentData);
    ...
    useEffect(() => {
        ...
        const filtered = employmentData.filter((item) =>
